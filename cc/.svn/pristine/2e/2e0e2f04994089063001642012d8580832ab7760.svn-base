...
public class Stock {
	...
	public String toString() {
		return "code=" + code + ", name=" + name + ", prevclose=" + prevclose + ", current_price=" + current_price + ", maxprice=" + maxprice + ", minprice=" + minprice + ", open_price=" + open_price + ", marketType=" + marketType + ", stockPinYin=" + stockPinYin + ", risePrice=" + risePrice;
	}
