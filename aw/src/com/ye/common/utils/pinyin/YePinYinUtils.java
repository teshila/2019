package com.ye.common.utils.pinyin;
...
//https://blog.csdn.net/e_real/article/details/41682131

public class YePinYinUtils {
	...
	public static void initPinyin() {
		// 读取多音字的全部拼音表;
		InputStream file = YePinYinUtils.class.getResourceAsStream("/duoyinzi_dic.txt");
